  ...
  return (
    <div style={overlay}>
      <div className="card" style={modal}>
        <h3 className="display" style={{ fontSize: 20, color: "#7E2F44" }}>Before you continue</h3>
        <ul style={{ fontSize: 13.5, color: "#3C2A2F", lineHeight: 1.7, paddingLeft: 18, marginTop: 12 }}>
...
const overlay = {
  position: "fixed", inset: 0, background: "rgba(43,30,34,0.45)",
