        ...
        <div className="doc-body">
          ...
          <Clause n={next()} title="Status of this document">
            <p className="doc-text">
              ...
              the person named nowhere in it. <strong>It is not a diagnosis and not a
              laboratory result.</strong> It records what a
      ...
      <table className="doc-table">
        <tbody>
          <tr>
            ...
            <td>
              Conjunctival colour analysis of a single camera frame. {a.features?.roiPixelCount} pixels
              passed the hue/saturation filter ({Math.round((a.features?.roiRatio ?? 0) * 100)}% of those
              sampled). Scored on a weighted combination of green-to-red ratio (50%), HSV saturation
              (30%) and green percentage (20%).
            </td>
          </tr>
          <tr>
            <td className="doc-cell-key">Pallor score</td>
            <td>{a.pallorScore} of 1.00 (band: {a.severity})</td>
          </tr>
          <tr>
            <td className="doc-cell-key">Reading confidence</td>
            <td>{Math.round(a.confidence * 100)}% — capture quality {a.captureQuality}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              ...
              against paired haemoglobin results in this population. Two known confounds are
              uncorrected: warm (tungsten) lighting biases the reading toward "healthy", and the
              hue filter can discard very pale tissue. Treat a negative with corresponding caution.
            </td>
          </tr>
        </tbody>
      </table>
