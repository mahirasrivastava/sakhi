  ...
  return (
    <div className="container" style={{ paddingTop: 44, paddingBottom: 60, maxWidth: 720 }}>
      ...
      <div className="card" style={{ marginTop: 30 }}>
        <h3 className="display" style={{ fontSize: 18, color: "#7E2F44" }}>Live session counter</h3>
        {stats ? (
          <>
          ...
          <p style={{ color: "#9C8A8F", marginTop: 10 }}>No sessions logged yet.</p>
        )}
      </div>

      <div className="card" style={{ marginTop: 20 }}>
        <h3 className="display" style={{ fontSize: 18, color: "#7E2F44" }}>Why privacy, not just proximity</h3>
        <p style={{ fontSize: 14.5, color: "#3C2A2F", marginTop: 10, lineHeight: 1.7 }}>
...
function StatCard({ big, label }) {
  return (
    <div className="card" style={{ textAlign: "center" }}>
      <p style={{ fontSize: 32, fontFamily: "Fraunces, serif", color: "#B04A63", margin: 0 }}>{big}</p>
      <p style={{ fontSize: 12.5, color: "#6B5A5F", marginTop: 8, lineHeight: 1.5 }}>{label}</p>
    </div>
  );
}
